 ...
 * 
 * 
 * As seen <a href="http://today.java.net/pub/a/today/2008/10/23/creating-a-notifying-blocking-thread-pool-executor.html">
 * here</a>.
 *
...
public class NotifyingBlockingThreadPoolExecutor extends ThreadPoolExecutor {
		...
		public void await() throws InterruptedException {
			...
			try {
			    if( waiter == null ) {
	                ...
	                throw new IllegalStateException( "Another thread has already called await. Only one waiter allowed!" +
	                        "\nThread: " + waiter );
	            }
	...
	public static final Semaphore semaphoreForTesting = new Semaphore( 1 );
